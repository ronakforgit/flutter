...
Build & Test flutter on Harness CI
=======================================
This is a fork of [flutter/flutter](https://github.com/flutter/flutter). This project is used for testing Harness CI's capabilities by the CME team at Harness. This file contains instructions on how to run flutter/flutter on Harness CI.
...
1. Fork [this repository](https://github.com/flutter/flutter) into your GitHub account. 
 ...
 * Follow the below steps to set up your pipeline:-
   ...
   6. Select your `Repository` here `flutter`.
          ...
          execution:
            steps:
              - step:
                  ...
                  spec:
                    shell: Bash
                    command: pushd packages/flutter;../../bin/flutter test --coverage -j 1;popd
```
